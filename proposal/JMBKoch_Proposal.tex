...
\documentclass[
  english,
  man]{apa6}
\title{Getting a Step Ahead: Using the Regularized Horseshoe Prior to Regularize Cross-Loadings in Bayesian CFA}
\author{\phantom{0}}
\date{}
...
\hypersetup{
  pdftitle={Getting a Step Ahead: Using the Regularized Horseshoe Prior to Regularize Cross-Loadings in Bayesian CFA},
  pdflang={en-EN},
  hidelinks,
...
(Muthen \& Asparouhov, 2012). As solution,
...
All models will be sampled using the No-U-Turn-Sampler (Betancourt, 2018; Homan \& Gelman, 2014). We aim to identify a suitable chain length in the pilot study.
