...
- In Regression & Machine Learning: Penatalization, such as *LASSO* [@tibshirani_regression_1996] or *Ridge* [@hoerl_ridge_2000]
...
- Regularized Horseshoe prior [@piironen_sparsity_2017]: limits shrinkage of small coefficients for the sake of identification

$\beta_j | \hat{\tau}^2, \lambda \sim \mathcal{N}(0,  \hat{\tau}^2 \lambda )$ , where  $\hat{\tau}^2 = \frac{c^2\tau^2}{c^2+\lambda^2\tau_j^2}$

$\lambda | \lambda^2_0 \sim HC(0, \lambda^2_0)$, where $\lambda_0 = \frac{p_0}{p - p_0} \frac{\sigma}{\sqrt{N}}$
