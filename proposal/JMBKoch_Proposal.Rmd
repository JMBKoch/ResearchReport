...
Conditions are based on [@lu_bayesian_2016] and will include two factor structus (1 non-zero cross-loading, several non-zero crossloadings), three sample sizes (100, 200, 300), and three magnitudes of the cross-loadings (0.1, 0.2, 0.3).
