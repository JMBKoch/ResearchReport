...
#TypeISVNP <- 
 resultsSVNP %>% 
  ...
  summarise(typeITres0.10Mean_2 = mean(isZeroTres0.10Mean_2),
            ...
            typeICI95Mean_2 = mean(isZero95CI_2),
            typeICI95Mean_3 = mean(isZero95CI_3),
            typeICI95Mean_4 = mean(isZero95CI_4),
            typeICI95Mean_5 = mean(isZero95CI_5),
        N = mean(N),
        cross = mean(cross),
...
#PowerSVNP <- 
 resultsSVNP %>% 
  ...
  group_by(condID) %>% 
  summarise(powerTres0.10Mean_1 = mean(isZeroTres0.10Mean_1), 
            powerTres0.10Mean_6 = mean(isZeroTres0.10Mean_6), 
            powerCI95Mean_1 = mean(isZero95CI_1),
            powerCI95Mean_6 = mean(isZero95CI_6),
        N = mean(N),
        cross = mean(cross),
        sigmaSqu = mean(sigmaSqu))
