...
The bias in the estimates of the residual variances $\bar{\theta}_{1-6}$ is not substantial across different conditions, although also here a noticeable increase occurs between true cross-loadings of 0.2 and 0.5 when $\sigma^2 = 0.001$.
